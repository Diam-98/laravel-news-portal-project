...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('back/assets/plugins/fontawesome/css/fontawesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('back/assets/plugins/fontawesome/css/all.min.css') }}">
...
<div class="main-wrapper login-body">
    <div class="login-wrapper">
        <div class="container">
            <div class="loginbox">
                <div class="login-left"> <img class="img-fluid" src="{{ asset('back/assets/img/logo.png') }}" alt="Logo"> </div>
